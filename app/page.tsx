...
function FeatureCard({ title, description, icon }: FeatureCardProps) {
  return (
    <div className="p-6 bg-white rounded-xl shadow-sm hover:shadow-md transition-shadow">
      <div className="w-12 h-12 text-sky-600 mb-4">
        {icon}
      </div>
      ...
      <main className="pt-16">
        ...
        <section id="features" className="py-20 bg-white">
          <div className="container mx-auto px-4">
            ...
            <p className="text-lg text-gray-600 text-center mb-12 max-w-2xl mx-auto">
              Meet like-minded people in your vicinity while maintaining complete control over your privacy and safety.
            </p>
            ...
            <div className="max-w-3xl mx-auto text-center">
              ...
              <div className="space-y-8">
                <div className="flex items-center gap-4 text-left">
                  <div className="w-12 h-12 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center flex-shrink-0 text-xl font-bold">1</div>
                  <div>
                    <h3 className="font-semibold text-xl mb-1">Create Your Profile</h3>
                    <p className="text-gray-600">Set up your interests, preferences, and discovery settings</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 text-left">
                  <div className="w-12 h-12 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center flex-shrink-0 text-xl font-bold">2</div>
                  <div>
                    <h3 className="font-semibold text-xl mb-1">Enable Discovery Mode</h3>
                    <p className="text-gray-600">Get notified when compatible people are nearby</p>
                  </div>
                </div>
                <div className="flex items-center gap-4 text-left">
                  <div className="w-12 h-12 rounded-full bg-sky-100 text-sky-600 flex items-center justify-center flex-shrink-0 text-xl font-bold">3</div>
                  <div>
                    <h3 className="font-semibold text-xl mb-1">Connect Safely</h3>
                    <p className="text-gray-600">Meet at verified public places with built-in safety features</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                We've built comprehensive safety features into every aspect of Disco
              </p>
              <div className="grid md:grid-cols-2 gap-6 text-left">
                <div className="p-6 bg-sky-50 rounded-xl">
                  <h3 className="font-semibold text-xl mb-3">Privacy Protection</h3>
                ...
                <div className="p-6 bg-sky-50 rounded-xl">
                  <h3 className="font-semibold text-xl mb-3">Safety Features</h3>
                  <ul className="space-y-2 text-gray-600">
        ...
        <section className="py-20 bg-gradient-to-b from-sky-50 to-white">
          <div className="container mx-auto px-4 text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join a community of people making meaningful connections every day.
            </p>
            <div className="flex gap-4 justify-center">
              <Link href="/signup">
